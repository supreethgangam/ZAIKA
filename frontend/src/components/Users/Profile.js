        ...
        <Paper>
          <Table size="small">
            ...
            <TableBody>
              ...
              <TableRow>
                <TableCell size="medium">Age</TableCell>
                <TableCell><Chip label={details.age} color="primary" /></TableCell>
              </TableRow>
              <TableRow>
                <TableCell size="medium">Batch</TableCell>
                <TableCell><Chip label={details.batch} color="primary" /></TableCell>
              </TableRow>
            </TableBody>
